...
using Norboev_Asilbek_HW4.DAL;
using Norboev_Asilbek_HW4.Models;
...
String connectionString = "Server=tcp:fa23norboevasilbekhw4.database.windows.net,1433;Initial Catalog=fa23norboevasilbekhw4;Persist Security Info=False;User ID=MISAdmin;Password=Password123;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
